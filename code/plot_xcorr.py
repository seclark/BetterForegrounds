...
ax.errorbar(Planckdata.ell*(1 - ellnudge), Planckdata.EE, yerr=[Planckdata.EE_err, Planckdata.EE_err], ms = 7, fmt='o', markerfacecolor='darkblue', mec='white',  ecolor = "gray", elinewidth=2, capsize=0, capthick=2, label=r"$Planck$ $\mathrm{EE}$")
ax.errorbar(RawPlanckdata.ell*(1 + 0*ellnudge), RawPlanckdata.EE, yerr=[RawPlanckdata.EE_err, RawPlanckdata.EE_err], ms = 7, fmt='o', markerfacecolor='lightsteelblue', mec = 'white', ecolor = "gray", elinewidth=2, capsize=0, capthick=2, label=r"$\mathrm{Raw}$ $Planck$ $\mathrm{EE}$")
ax.errorbar(RHTdata3.ell*(1 + 1*ellnudge), RHTdata3.EE, yerr=[RHTdata3.EE_err, RHTdata3.EE_err], ms = 7, fmt='o', markerfacecolor='steelblue', mec = 'white', ecolor = "gray", elinewidth=2, capsize=0, capthick=2, label=r"$Planck$ $+$ $\mathrm{max(RHT) - RHT}$ $\mathrm{EE}$")
...
ax.errorbar(RHTdataAvM.ell*(1 + 3*ellnudge), RHTdataAvM.EE, yerr=[RHTdataAvM.EE_err, RHTdataAvM.EE_err], ms = 7, fmt='o', markerfacecolor='darkturquoise', mec = 'white', ecolor = "gray", elinewidth=2, capsize=0, capthick=2, label=r"$Planck$$+$$\theta_{\mathrm{RHT}}$ $\mathrm{EE}$")
ax.errorbar(RHTdata2.ell*(1 + 3*ellnudge), RHTdata2.EE, yerr=[RHTdata2.EE_err, RHTdata2.EE_err], ms = 7, fmt='o', markerfacecolor='darkturquoise', mec = 'white', ecolor = "gray", elinewidth=2, capsize=0, capthick=2, label=r"$Planck$ $+$ $\mathrm{med(RHT) - RHT}$ $\mathrm{EE}$")
#ax.errorbar(RHTdatapatch.ell*(1 + 3*ellnudge), RHTdatapatch.EE, yerr=[RHTdatapatch.EE_err, RHTdatapatch.EE_err], ms = 7, fmt='o', markerfacecolor='blue', mec = 'white', ecolor = "gray", elinewidth=2, capsize=0, capthick=2, label=r"$Planck$ $+$ $\mathrm{1 - RHT}$ $\mathrm{EE}$")

ax.errorbar(Planckdata.ell*(1 - ellnudge), Planckdata.BB, yerr=[Planckdata.BB_err, Planckdata.BB_err], ms = 7, fmt='s', markerfacecolor='crimson', mec='white', ecolor = "gray", elinewidth=2, capsize=0, capthick=2, label=r"$Planck$ $\mathrm{BB}$")
ax.errorbar(RawPlanckdata.ell*(1 + 0*ellnudge), RawPlanckdata.BB, yerr=[RawPlanckdata.BB_err, RawPlanckdata.BB_err], ms = 7, fmt='s', markerfacecolor='navajowhite', mec = 'white', ecolor = "gray", elinewidth=2, capsize=0, capthick=2, label=r"$\mathrm{Raw}$ $Planck$ $\mathrm{BB}$")
ax.errorbar(RHTdata3.ell*(1 + 1*ellnudge), RHTdata3.BB, yerr=[RHTdata3.BB_err, RHTdata3.BB_err], ms = 7, fmt='s', markerfacecolor='darkorange', mec = 'white', ecolor = "gray", elinewidth=2, capsize=0, capthick=2, label=r"$Planck$ $+$ $\mathrm{max(RHT) - RHT}$ $\mathrm{BB}$")
...
ax.errorbar(RHTdataAvM.ell*(1 + 3*ellnudge), RHTdataAvM.BB, yerr=[RHTdataAvM.BB_err, RHTdataAvM.BB_err], ms = 7, fmt='s', markerfacecolor='sandybrown', mec = 'white', ecolor = "gray", elinewidth=2, capsize=0, capthick=2, label=r"$Planck$$+$$\theta_{\mathrm{RHT}}$ $\mathrm{BB}$")
ax.errorbar(RHTdata2.ell*(1 + 3*ellnudge), RHTdata2.BB, yerr=[RHTdata2.BB_err, RHTdata2.BB_err], ms = 7, fmt='s', markerfacecolor='sandybrown', mec = 'white', ecolor = "gray", elinewidth=2, capsize=0, capthick=2, label=r"$Planck$ $+$ $\mathrm{med(RHT) - RHT}$ $\mathrm{BB}$")
#ax.errorbar(RHTdatapatch.ell*(1 + 3*ellnudge), RHTdatapatch.BB, yerr=[RHTdatapatch.BB_err, RHTdatapatch.BB_err], ms = 7, fmt='s', markerfacecolor='red', mec = 'white', ecolor = "gray", elinewidth=2, capsize=0, capthick=2, label=r"$Planck$ $+$ $\mathrm{1 - RHT}$ $\mathrm{BB}$")
...
ax.legend(numpoints=1, ncol=1, fancybox=True, borderpad=0.5, bbox_to_anchor=(1.4, 1.0), frameon=False)
