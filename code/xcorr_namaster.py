...
def make_mask(nside, GALFA_cut=False, b_cut=False, save_mask=False, nonabsb_cut=False, nonabsb_cut_gt=False):
    ...
    out_fn = "../data/masks/mask_nside{}_GALFAcut{}_b_cut{}_nonabsb_cut{}_nonabsb_cut_gt{}.fits".format(nside, GALFA_cut, b_cut, nonabsb_cut, nonabsb_cut_gt)
...
def get_planck_data(nu=353, local=False, Ionly=False, QU=False, IQU=False, vers="R3.01", HM=False):
    ...
    if HM is False:
        ...
        planck_fn = planck_root + "HFI_SkyMap_{}{}_2048_{}_halfmission-2.fits".format(nu, nustr, vers)
