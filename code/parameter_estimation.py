...
sigma_p[0, 0, :] = (1.0/map353Gal[0])*cov353Gal[1, 1, :] #QQ
sigma_p[0, 1, :] = (1.0/map353Gal[0])*np.sqrt(cov353Gal[1, 2, :]) #QU
sigma_p[1, 0, :] = (1.0/map353Gal[0])*np.sqrt(cov353Gal[1, 2, :]) #QU
sigma_p[1, 1, :] = (1.0/map353Gal[0])*cov353Gal[2, 2, :] # UU
